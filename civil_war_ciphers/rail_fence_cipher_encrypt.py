...
Example text to encrypt: 'Buy more Maine Pototoes'
...
# the string to encrypted (paste between quotes):
...
def encrypt(rails):
    '''Split letters in ciptertext into chuncks of 5 & join to make string'''
