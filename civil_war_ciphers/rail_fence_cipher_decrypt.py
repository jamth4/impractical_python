...
# the string to be decrypted (pasted between quotes):
...
def split_rails(message):
    '''Split message in two, always rounding UP for the 1st row.'''
...
def decrypt(row1, row2):
    '''Build list with every otehr letter in 2 strings & print'''
    plaintext = []
